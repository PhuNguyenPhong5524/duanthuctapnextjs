        ...
        <div>
            <div className="mb-[10px]">
                <div className="flex mb-[5px] mt-[10px]">
                    <div className="mr-[10px]"><i className="fa-regular fa-circle-user text-[40px]"></i></div>
                    <div className="mt-[10px]"><p className="text-[14px] font-sans font-bold">Name Surname</p></div>
                </div>
