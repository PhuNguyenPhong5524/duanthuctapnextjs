    ...
    return (
        <div className="bg-[#f1f1f1]">
            ...
            <div className="mx-[225px] flex items-center justify-between pt-[15px] ">
                <div className=""><a href="http://localhost:3000"><h1 className='text-[39px] font-semibold font-sans '>YOUR LOGO</h1></a></div>
                <div className="flex items-center gap-[20px] ">
                    ...
                    <div className=" border-r-2 border-r-black pr-2 cursor-pointer">
                        <a href="http://localhost:3000/cart" className="flex justify-center">
            ...
            <div className="pt-[10px]">
                <ul className="flex items-center justify-center bg-[#fff] w-full relative" style={{ boxShadow: '0px 8px 24px rgba(139, 146, 153, 0.2)', marginBottom: '-24px' }}>
                    ...
                    <li className="text-[#555555] hover:bg-[#f1f5f9]  font-bold hover:text-[black] p-[10px] rounded-[5px] " ><a href="http://localhost:3000/product" className="text-[14px]">MAKE UP</a></li>
